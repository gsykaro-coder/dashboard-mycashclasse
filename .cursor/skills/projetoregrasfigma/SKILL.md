---
name: projetoregrasfigma
description: Regras para implementação do dashboard mycash+ seguindo design system do Figma, com hierarquia de variáveis (semântica → primitiva → conversão), layout fluido mobile-first, responsividade obrigatória e padrões de componentização React + TypeScript + Tailwind
filePatterns:
  - "**/*.tsx"
  - "**/*.ts"
  - "**/*.css"
